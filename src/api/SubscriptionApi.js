...
class SubscriptionApi extends BaseApi {
    ...
    getSubscriptions(data) {
        ...
        return axios.get(
            `${this.REACT_APP_SERVER_URL}/payments/plans?group_type=${group_type}&lesson_type=${lesson_type}&duration=${parseInt(duration)}`,
            {
                headers: {
    ...
    getPlan(data) {
        ...
        return axios.get(
            `${this.REACT_APP_SERVER_URL}/payments/plan?group_type=${group_type}&lesson_type=${lesson_type}&duration=${parseInt(duration)}${period ? '&period=' + period : ''}`,
            {
                headers: {
                    'Authorization': `Bearer ${this.getToken()}`
                }
    ...
    getPlanStatus(data) {
        ...
        return axios.get(
            `${this.REACT_APP_SERVER_URL}/payments/status?${query}`,
            {
                headers: {
                    'Authorization': `Bearer ${this.getToken()}`
                }
