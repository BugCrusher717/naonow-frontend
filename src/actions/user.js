...
export function uploadPreset(avatar, user_id) {
  ...
  function request() { return { type: ActionTypes.UPLOAD_PRESET.REQUEST } }
  function success(data) { return { type: ActionTypes.UPLOAD_PRESET.SUCCESS, payload: data } }
  function failure(error) { return { type: ActionTypes.UPLOAD_PRESET.FAILURE, payload: error } }
}
