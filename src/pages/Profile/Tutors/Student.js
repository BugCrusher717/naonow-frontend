            ...
            /> : <>
              <div className="tutor-student-profile">
                <div className="avatar">
                  <Avatar avatar={student.user.avatar} name={getAvatarName(student.user.first_name, student.user.last_name)} />
                </div>
                <div className="info">
                  <div>
                  ...
                  <div>
                    <Link to={{ pathname: '/messages', state: { user_id: student_id } }}>{t('send_message')}</Link>
                  </div>
                </div>
              </div>
              <div className="m-t-48">
                <Lessons appointments={appointments} title={t('upcoming_lessons')} status="upcoming" />
              </div>
              <div className="m-t-48"></div>
              <Lessons appointments={appointments} title={t('past_lessons')} status="past" />
              ...
              {appointments && appointments.loading && <Loader
                className="align-center"
                type="Audio"
                color="#00BFFF"
                height={50}
