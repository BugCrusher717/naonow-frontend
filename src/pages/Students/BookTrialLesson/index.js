  ...
  return (
    <Layout>
      <div className="make-appointment-layout">
        ...
        {tabIndex === 1 && <BookTimeTrial onContinue={onContinue} onBack={onBack} selectedTime={setSelectedTime} />}
        {tabIndex === 2 && <SelectTutor onContinue={onContinue} onBack={onBack} selectedTutor={setSelectedTutor} />}
        {tabIndex === 3 && <LessonConfirmation onContinue={onContinue} onBack={onBack} tutor={selectedTutor} time={selectedTime} onContinue={onContinue} />}
      </div>
