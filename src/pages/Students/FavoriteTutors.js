...
const FavoriateTutor = (props) => {
  ...
  return <div className="favorite-tutor-card">
    <div className="info">
    ...
    <div className="right">
      ...
      <div className="intro-video">
        <iframe className="vimeo" width="258" height="144" src={tutor.video_url} frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
      </div>
      <div className="btn" onClick={onSelect}>{t('see_profile')}</div>
    </div>
  </div>
}
      ...
      <div className="favourite-tutors-layout">
        ...
        <div className="scroll-layout">
          <div className="tutors-wrapper">
            {favoriteTutors && favoriteTutors.map((tutor) =>
              <FavoriateTutor
                key={tutor.id}
                tutor={tutor}
