        ...
        <div className="scroll-layout">
          <div className="select-first-criteria">
            ...
            <div className="criteria-select-box">
              <div className="img"><img src={ImgClock} alt="" /></div>
              <Link className="btn" to={{ pathname: "/student/schedule-lesson", state: { timeFirst: true } }}>{t('select_time_first')}</Link>
            </div>
            <div className="criteria-select-box">
              <div className="img"><img src={ImgTutor} alt="" /></div>
              <Link className="btn" to={{ pathname: "/student/schedule-lesson", state: { tutorFirst: true } }}>{t('select_tutor_first')}</Link>
            </div>
          </div>
            ...
            planStatus.length === 0
              ...
              <>
                <div className="lesson-brief-wraper">
                  ...
                  <div>
                    {planStatus.map((lesson, index) => <div key={`lesson-${index}`} className="lesson">
                      <div>
                      ...
                      <div className="duration-box">
                        ...
                        <span className={`remains d-${lesson.duration}m`}>{lesson.total_lessons - lesson.lessons}</span>
                      </div>
                    </div>)}
                  </div>
                </div>
          ...
          <Link to="/student/packages" className="btn">+ {t('buy_another_plan')}</Link>
        </div>
      </div>
    </Layout >
  )
