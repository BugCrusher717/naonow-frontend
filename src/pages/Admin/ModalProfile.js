          ...
          <div className="info">
            <div>
              ...
              <div className="basic">
                ...
                <p className="acceptance-rate">{t('acceptanceRate')} {tutor.acceptanceRate}%</p>
              </div>
            ...
            <div>
              <div className="btn outlined" onClick={() => setExpand(true)}>{t('see_profile')}</div>
              <div className="btn" onClick={() => { onDismiss(); onSelect(); }}>{t('select_tutor')}</div>
            </div>
          </div>
          <iframe className="vimeo" width="1032" height="582" src={tutor.introVideo} frameBorder="0"
        ...
        <div className="expand">
          ...
          <div className="profile-content">
            ...
            <div className="reviews">
              <p className="sub-title">{t('tutor_reviews')} ({tutor.reviews?.length})</p>
              <div className="wrapper">
                {tutor.reviews?.map(review => <div className="review">
                  ...
                  <div className="provider">
                    ...
                    <div className="provider-info">
                      ...
                      <p className="date">{review.provided_at.toLocaleDateString()}</p>
                    </div>
                  </div>
                </div>)}
              </div>
