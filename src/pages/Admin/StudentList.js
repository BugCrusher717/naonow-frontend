  ...
  const columns = [
    {
      ...
      dataKey: 'level',
      width: 20,
      render: (level) => <span>{t('level')} #{level ? level : 1}</span>
    }, {
      title: t('last_lesson_number'),
      dataKey: 'last_lesson',
      width: 20,
      render: (last_lesson) => <span>{last_lesson ? `${t('lesson')} #${last_lesson}` : ''}</span>
    }, {
    ...
    <Layout>
      <div className="student-list-layout">
        <div className="page-header">
          ...
          <div className="controls">
            <div className="search">
              <input type="text" placeholder={t('search_student')} onChange={(event) => {
        ...
        <div className="scroll-layout">
          {students.length > 0 && <CustomTable data={students} columns={columns} enableSeeAll={false} />}
