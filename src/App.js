    ...
    <Provider store={store}>
      <Router>
        ...
        <div className="App">
          ...
          <PrivateRoute path="/admin/schedule-new-lesson" component={ScheduleLessonSteps} />
          <PrivateRoute path="/admin/lesson-calendar" component={TutorCalendar} />
          ...
          <PrivateRoute path="/student/lesson-complete/:complete_appoint_id" component={StudentListAppointments} />
          <PrivateRoute path="/student/manage-lessons" component={StudentListAppointments} />
          <PrivateRoute path="/student/schedule-lesson/select" component={ScheduleLesson} />
          <PrivateRoute path="/student/schedule-lesson/group-select" component={GroupScheduleLesson} />
          <PrivateRoute exact path="/student/schedule-lesson" component={ScheduleLessonSteps} />
          <PrivateRoute exact path="/student/appointments" component={StudentListAppointments} />
          ...
          <PrivateRoute path="/student/group-lessons" component={GroupLessons} />
          <PrivateRoute path='/student/favorite-tutors' component={FavouriteTutors} />
          <PrivateRoute path='/student/class-materials' component={ClassMaterials} />
          <PrivateRoute path='/student/book-trial-lesson' component={BookTrialLesson} />
          ...
          <PrivateRoute path="/tutor/availability" component={AvailabilityLayout} />
