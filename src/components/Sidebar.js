...
const tutorNavLinks = [
  { label: 'manage_appointments', link: '/tutor/manage-appointments', icon: Icon1, activeIcon: ActiveIcon1 },
  { label: 'appointment_calendar', link: '/tutor/appointments-calendar', icon: Icon2, activeIcon: ActiveIcon2 },
  { label: 'check_requests', link: '/approve-requests', icon: Icon11, activeIcon: ActiveIcon11 },
  { label: 'my_availability', link: '/tutor/availability', icon: Icon19, activeIcon: ActiveIcon19 },
  { label: 'student_list', link: '/tutor/students', icon: Icon4, activeIcon: ActiveIcon4 },
  ...
  { label: 'payment', link: '/tutor/payment-page', icon: Icon12, activeIcon: ActiveIcon12 },
  // { divider: true },
  // { label: 'feedback', link: '/feedback', icon: Icon14, activeIcon: ActiveIcon14 }
];

const studentNavLinks = [
  { label: 'manage_lessons', link: '/student/manage-lessons', icon: Icon1, activeIcon: ActiveIcon1 },
  { label: 'lesson_calendar', link: '/student/lesson-calendar', icon: Icon2, activeIcon: ActiveIcon2 },
  // { label: 'past_lessons', link: '/student/past-lessons', icon: Icon3, activeIcon: ActiveIcon3 },
  { label: 'messages', link: '/messages', icon: Icon5, activeIcon: ActiveIcon5 },
  { label: 'favorite_tutors', link: '/student/favorite-tutors', icon: Icon9, activeIcon: ActiveIcon9 },
  // { label: 'class_materials', link: '/student/class-materials', icon: Icon10, activeIcon: ActiveIcon10 },
  { label: 'packages', link: '/student/packages', icon: Icon11, activeIcon: ActiveIcon11 },
  // { divider: true },
...
const adminNavLinks = [
  { label: 'tutor_list', link: '/admin/tutor-list', icon: Icon16, activeIcon: ActiveIcon16 },
  { label: 'student_list', link: '/admin/student-list', icon: Icon17, activeIcon: ActiveIcon17 },
  { label: 'admin', link: '/admin/main', icon: Icon18, activeIcon: ActiveIcon18 },
  { label: 'appointment_calendar', link: '/admin/lesson-calendar', icon: Icon2, activeIcon: ActiveIcon2 },
];
        ...
        <div className="link-list">
          {
            navLinks && navLinks.map((item, index) => (
              item.divider ? <div key={`divider-${index}`} className="divider" /> :
